...
def icp_matching(previous_points, current_points):
    ...
    while dError >= EPS:
        ...
        #alteracao1 print("Residual:", error)
        ...
        if dError <= EPS:
            #alteracao1 print("Converge", error, dError, count)
            break
        elif MAX_ITER <= count:
            print("Not Converge2...", error, dError, count)
            break
...
def main():
    #alteracao1 print(__file__ + " start!!")
    ...
    for _ in range(nsim):
        ...
        #alteracao1 print("R:", R)
        #alteracao1 print("T:", T)
